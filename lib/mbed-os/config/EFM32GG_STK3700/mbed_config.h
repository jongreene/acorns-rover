...
#define CORE_CLOCK_SOURCE                                                     HFXO                                                                                             // set by target:EFM32GG_STK3700
#define EFM_BC_EN                                                             PF7                                                                                              // set by target:EFM32GG_STK3700
#define HFRCO_FREQUENCY                                                       21000000                                                                                         // set by target:EFM32GG_STK3700
#define HFRCO_FREQUENCY_ENUM                                                  _CMU_HFRCOCTRL_BAND_21MHZ                                                                        // set by target:EFM32GG_STK3700
#define HFXO_FREQUENCY                                                        48000000                                                                                         // set by target:EFM32GG_STK3700
#define LFXO_FREQUENCY                                                        32768                                                                                            // set by target:EFM32GG_STK3700
#define LOW_ENERGY_CLOCK_SOURCE                                               LFXO                                                                                             // set by target:EFM32GG_STK3700
...
#define MBED_CONF_PLATFORM_STDIO_BAUD_RATE                                    115200                                                                                           // set by library:platform[EFM32]
